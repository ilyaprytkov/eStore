module.exports = [
"[externals]/@prisma/client/extension [external] (@prisma/client/extension, cjs, [project]/node_modules/@prisma/client)", ((__turbopack_context__, module, exports) => {

var mod = __turbopack_context__.x("@prisma/client-2c3a283f134fdcb6/extension", () => require("@prisma/client-2c3a283f134fdcb6/extension"));
...
var UNKNOWN_ERROR_CODE_PREFIX = "UNKNOWN_SQLITE_ERROR_";
        ...
        case "SQLITE_CONSTRAINT_PRIMARYKEY":
            {
                ...
                const table = columns?.at(0)?.split(".").slice(0, -1).join(".") || void 0;
                return {
        ...
        default:
            {
                ...
                if (error.code.startsWith("SQLITE_BUSY") || extendedCode !== void 0 && (extendedCode & PRIMARY_ERROR_CODE_MASK) === SQLITE_BUSY) {
                    return {
                        kind: "SocketTimeout"
                    };
...
function checkIsOnDemandRevalidate(rawHeaders, previewProps) {
    ...
    if (typeof rawHeaders.get === 'function') {
        const headers = _headers.HeadersAdapter.from(rawHeaders);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0u22cwd._.js.map